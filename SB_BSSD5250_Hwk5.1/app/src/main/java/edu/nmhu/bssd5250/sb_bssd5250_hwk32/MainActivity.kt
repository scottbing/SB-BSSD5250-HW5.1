...
import edu.nmhu.bssd5250.sb_bssd5250_hwk32.Note
import edu.nmhu.bssd5250.sb_bssd5250_hwk32.NoteFragment
import edu.nmhu.bssd5250.sb_bssd5250_hwk32.NotesData
import edu.nmhu.bssd5250.sb_bssd5250_hwk32.NotesData.toJSON
...
class MainActivity : AppCompatActivity() {
            ...
            setOnClickListener {
                supportFragmentManager.commit {
                    ...
                    if (supportFragmentManager.fragments.size >= 10) {
                        ...
                        which = false
                        NotesData.addNote(Note("", "", null))
                        val uniqueID = NotesData.getNoteList().size-1
                        add(fid, NoteFragment.newInstance(uniqueID, which), null)
                    }
                }
            }
        }
    ...
    private fun writeDataToFile() {
        ...
        val data:String = toJSON().toString()
